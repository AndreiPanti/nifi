...
public class QueryMarkLogicIT extends AbstractMarkLogicIT {
    ...
    public void testSimpleCollectionQuery() {
        ...
        assertEquals(originalFlowFile.getAttribute("marklogic-query"), 
        "The attribute name should be delivered on the success FlowFile so that a user knows what was executed to " + 
